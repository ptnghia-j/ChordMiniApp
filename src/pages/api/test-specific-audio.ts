...
/**
 * API endpoint to test the Music.ai API with a specific audio file
 *
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const { audioFile, workflow, params } = req.query;
  */
    ...
    const audioFilePath = path.join(process.cwd(), 'public', 'audio', audioFile as string);
